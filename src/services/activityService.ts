...
export async function fetchActivities(
  ...
  try {
    ...
    logger.error(CAT, 'fetchActivities exception', { error: message });
...
export async function fetchActivityById(
  ...
  try {
    ...
    logger.error(CAT, 'fetchActivityById exception', { id, error: String(err) });
    return null;
  }
}
...
export async function deleteActivityEntry(
  ...
  try {
    ...
    const message = err instanceof Error ? err.message : String(err);
    logger.error(CAT, 'deleteActivityEntry exception', { activityId, error: message });
...
export async function deleteActivitiesByTask(taskId: string): Promise<void> {
  ...
  try {
    ...
    logger.error(CAT, 'deleteActivitiesByTask exception', { taskId, error: String(err) });
  }
}
