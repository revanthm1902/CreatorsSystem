  ...
  return (
    <div className="space-y-5 sm:space-y-8">
      ...
      {leaderboard.length >= 3 && (
        <div className="flex items-end justify-center gap-2 sm:gap-4 mb-6 sm:mb-8 px-1 sm:px-2">
          {/* 2nd Place */}
          <div className="flex flex-col items-center flex-1 max-w-28 sm:max-w-33">
            <div className="w-12 h-12 sm:w-20 sm:h-20 bg-gray-400/20 rounded-full flex items-center justify-center mb-2 border-2 border-gray-400/50">
              <span className="text-base sm:text-2xl font-bold text-gray-300">2</span>
            </div>
            <div className="rounded-xl p-2 sm:p-4 text-center w-full h-20 sm:h-28" style={{ backgroundColor: 'var(--bg-card)' }}>
              <p className="font-medium truncate text-[11px] sm:text-base" style={{ color: 'var(--text-primary)' }}>{leaderboard[1]?.full_name}</p>
              <div className="flex items-center justify-center gap-1 text-accent mt-1 sm:mt-2">
                <Zap className="w-3 h-3 sm:w-4 sm:h-4" />
                <span className="font-bold text-xs sm:text-base">{leaderboard[1]?.total_tokens}</span>
              </div>
            </div>
          </div>

          {/* 1st Place */}
          <div className="flex flex-col items-center -mt-8 flex-1 max-w-32 sm:max-w-36">
            <div className="w-14 h-14 sm:w-24 sm:h-24 bg-yellow-500/20 rounded-full flex items-center justify-center mb-2 border-2 border-yellow-500/50">
              <Trophy className="w-6 h-6 sm:w-10 sm:h-10 text-yellow-400" />
            </div>
            <div className="rounded-xl p-2 sm:p-4 text-center w-full h-22 sm:h-32 border border-yellow-500/30" style={{ backgroundColor: 'var(--bg-card)' }}>
              <p className="font-semibold truncate text-xs sm:text-base" style={{ color: 'var(--text-primary)' }}>{leaderboard[0]?.full_name}</p>
              <div className="flex items-center justify-center gap-1 text-yellow-400 mt-1 sm:mt-2">
                <Zap className="w-3.5 h-3.5 sm:w-5 sm:h-5" />
                <span className="text-sm sm:text-xl font-bold">{leaderboard[0]?.total_tokens}</span>
              </div>
            </div>
          </div>
          ...
          {/* 3rd Place */}
          <div className="flex flex-col items-center flex-1 max-w-28 sm:max-w-33">
            <div className="w-12 h-12 sm:w-20 sm:h-20 bg-orange-500/20 rounded-full flex items-center justify-center mb-2 border-2 border-orange-500/50">
              <span className="text-base sm:text-2xl font-bold text-orange-400">3</span>
            </div>
            <div className="rounded-xl p-2 sm:p-4 text-center w-full h-20 sm:h-28" style={{ backgroundColor: 'var(--bg-card)' }}>
              <p className="font-medium truncate text-[11px] sm:text-base" style={{ color: 'var(--text-primary)' }}>{leaderboard[2]?.full_name}</p>
              <div className="flex items-center justify-center gap-1 text-accent mt-1 sm:mt-2">
                <Zap className="w-3 h-3 sm:w-4 sm:h-4" />
                <span className="font-bold text-xs sm:text-base">{leaderboard[2]?.total_tokens}</span>
              </div>
            </div>
          </div>
        </div>
